...
public interface BookingStorage extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findAllByBookerIdAndStatusOrderByCreatedAtAsc(Long userId, Booking.Status status);
    ...
    List<Booking> findAllByItemUserIdAndStatusOrderByCreatedAtAsc(Long itemOwnerId, Booking.Status status);
